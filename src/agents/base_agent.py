...
ТВОЯ ВІДПОВІДЬ:"""
            ...
            return f"""⚠️ УВАГА: У базі знань НЕМАЄ інформації для цього питання.
...
- Скажи, що немає інформації про [тема питання] у Великій Британії
- Направ користувача до gov.uk або opora.uk
- Пам'ятай: всі питання стосуються ТІЛЬКИ Великої Британії (UK), навіть якщо країна не вказана"""
