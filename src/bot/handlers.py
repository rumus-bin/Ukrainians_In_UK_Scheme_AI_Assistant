...
class BotHandlers:
    ...
    async def handle_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        welcome_message = (
            ...
            "🚂 Моніторинг поїздів UK (затримки та скасування)\n\n"
    ...
    async def handle_help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        help_message = (
            ...
            "🚂 Моніторинг поїздів:\n"
            "• Автоматична перевірка розкладу щодня о 7:00\n"
            "• Повідомлення про затримки та скасування\n"
            "• Зміни платформ та часу відправлення\n"
            "• Інформація на українській мові\n\n"
